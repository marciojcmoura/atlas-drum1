// $Header: d:/cvsroot/ptdev/native/redcas/dcdflib/dcdflib.cpp,v 1.2 2001/07/24 21:31:39 fgroen Exp $
...
// MODIFICATION OF ORIGINAL LIBRARY FILE: 
// REPLACED CALL TO exit BY CALL TO throw()
// MODIFICATION MADE BY FRANK GROEN

//  if (msg != NULL) fprintf(stderr,"%s\n",msg);
//  exit(0);

#define DCDFLIB_ERROR 222
